...
<head>
    ...
    <title>Seção de Serviço Militar da 8ª Região Militar</title>
  ...
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="#" class="nav-link px-2 text-white">Publicações</a></li>
        <li><a href="#" class="nav-link px-2 text-white">Status de Indenização</a></li>
      </ul>
      ...
      <div class="text-end">
        <button type="button" class="btn btn-outline-light me-2">Acesso Administrativo</button>
      </div>
    </div>
  </div>
</header>
